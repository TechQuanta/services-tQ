// Hero.jsx (FIXED - Removed <IntroChatDrawer> Wrapper)
"use client";

import { Spotlight } from "../../../components/ui/spotlight";
import { DotPattern } from "../../../components/ui/dot-pattern";
import { ContainerTextFlip } from "../../../components/ui/container-text-flip";
// Removed: import IntroChatDrawer from './Meet'; 
// The Meet component should only be imported and used in the main layout file.


// We assume this component will receive the state control props 
// from its parent wrapper (the Meet component in the layout).
export default function Hero({ openChat, MEETING_SLUGS }) {
    // Note: The props { openChat, MEETING_SLUGS } 
    // are expected to be passed from the single Meet wrapper in your layout.
    
    return (
        // 🚨 Removed <IntroChatDrawer> wrapper here 🚨
        <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-6xl flex-col items-center justify-center px-4 py-20 text-center">
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-center">
                {/* Google Meet Button - Now opens the drawer with the PROJECT_DISCUSSION link */}
                <button 
                    // 🚨 CALL OPEN CHAT WITH THE PROJECT DISCUSSION SLUG 🚨
                ...
                {/* Portfolio Button (Kept as is, assuming it links to /work or similar) */}
        ...
        // 🚨 Removed the closing </IntroChatDrawer> tag here 🚨
    );
}